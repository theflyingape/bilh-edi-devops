    ...
    <template #default>
      <div class="flex flex-row justify-center">
        ...
        <div class="ml-6 w-1/3">
          <UTextarea v-model="b64" class="font-mono w-full" color="info" autoresize :maxrows="4" placeholder="base64 encoded ..." />
        </div>
        <div class="flex flex-col justify-start">
          <UButton size="sm" icon="i-lucide-clipboard-x" color="neutral" variant="link" @click="ascii=''" />
...
const data = shallowRef() as ShallowRef<Text | ArrayBuffer | Blob>
